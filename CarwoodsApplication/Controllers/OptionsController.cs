...
namespace CarwoodsApplication.Controllers
{
    ...
    public class OptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OptionId,Name,Description")] Option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OptionId,Name,Description")] Option option)
        {
            if (ModelState.IsValid)
            {
