...
namespace CarwoodsApplication.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CountryId,Title,CountryCode")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CountryId,Title,CountryCode")] Country country)
        {
            if (ModelState.IsValid)
            {
